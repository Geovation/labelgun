...
var labelgun = function () {
  ...
  _createClass(labelgun, [{
    ...
    value: function calculate() {
      ...
      var highest = Object.values(this.allLabels).sort(this.compare);

      highest.forEach(function (label) {

        var collisions = _this2.tree.search(label);
        var collisionsLower = _this2.allLower(collisions, label);
    ...
    key: "allLower",
    value: function allLower(collisions, label) {
      var lower = true;
    ...
    value: function _handlePreviousCollisions() {
      ...
      this.getHidden().forEach(function (hidden) {
        if (hidden.state === "hide") {
          ...
          var hiddenLabels = _this4.tree.search(hidden);
    ...
    value: function _hideShownCollisions() {
      ...
      this.getShown().forEach(function (label) {
        _this5.getCollisions(label.id).forEach(function (collision) {
