...
var labelgun = function () {
  ...
  _createClass(labelgun, [{
    ...
    */
    ...
    value: function _compareLabels() {
      ...
      this.orderedLabels.forEach(function (label) {
        ...
        var collisions = _this.tree.search(label);

        if (collisions.length === 0 || label.isDragged || _this._allLower(collisions, label)) {
          _this.allLabels[label.id].state = "show";
        }
      });
    }
    ...
    */
    ...
    value: function _setupLabels() {
      ...
      if (this.allChanged) {
        ...
        this.hasChanged.forEach(function (id) {
          _this2._handleLabelIngestion(id);
          _this2.tree.insert(_this2.allLabels[id]);
        });
    ...
    key: "removeLabel",
    value: function removeLabel(id, label) {
      var removelLabel = label || this.allLabels[id];
